 ...
 * @date 2018年6月24日
 */
public interface JobEvaluateOptionDao {
	/**
	 * 添加工作评价分项
	 ...
	 * @param endIndex 结束行号
	 * @return	分页查询到的工作评价分项数据集合
	 */
	List<JobEvaluateOption> getSubJobEvaluateOption(int startIndex,int endIndex);
	
	/**
	 * 模糊查询
	 * @param optionName  工作评价分项名称
